...
#if 0			
		printk(KERN_INFO "%s: !MAC_ADDR_EQUAL(pFrame->Hdr.Addr1, pAd->CurrentAddress): %s\n", __func__,
			(!MAC_ADDR_EQUAL(pFrame->Hdr.Addr1, pAd->CurrentAddress))?"OK":"ERR");

		printk(KERN_INFO "%s: !MAC_ADDR_EQUAL(%02x:%02x:%02x:%02x:%02x:%02x, 00:00:00:00:00:00): %s\n", __func__,
			...
			(!MAC_ADDR_EQUAL(pAd->ApCliMlmeAux.Bssid, ZERO_MAC_ADDR))?"OK":"ERR");
		
		printk(KERN_INFO "%s: MAC_ADDR_EQUAL(%02x:%02x:%02x:%02x:%02x:%02x, %02x:%02x:%02x:%02x:%02x:%02x): %s\n", __func__,
			pAd->ApCliMlmeAux.Bssid[0], pAd->ApCliMlmeAux.Bssid[1], pAd->ApCliMlmeAux.Bssid[2], 
			pAd->ApCliMlmeAux.Bssid[3], pAd->ApCliMlmeAux.Bssid[4], pAd->ApCliMlmeAux.Bssid[5], 
			pFrame->Hdr.Addr2[0], pFrame->Hdr.Addr2[1], pFrame->Hdr.Addr2[2],
			pFrame->Hdr.Addr2[3], pFrame->Hdr.Addr2[4], pFrame->Hdr.Addr2[5],
			MAC_ADDR_EQUAL(pAd->ApCliMlmeAux.Bssid, pFrame->Hdr.Addr2)?"OK":"ERR");
#endif
