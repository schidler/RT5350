...
#ifndef SYSTEM_LOG_SUPPORT
#define SYSTEM_LOG_SUPPORT 1
#endif
...
struct MAC_ADDRESS RestrictedMac;
...
PSTRING GetEncryptTypeForioctl(
	CHAR enc);

PSTRING GetAuthModeForIoctl(
	CHAR auth);
...
#define RtmpDrvSendWirelessEventExit(_pAd, _Event_flag, _pAddr, _BssIdx, _Rssi, _pEntry)
#define RtmpDrvSendWirelessEventApCli(a, b, c, d)
#endif /* SYSTEM_LOG_SUPPORT */
