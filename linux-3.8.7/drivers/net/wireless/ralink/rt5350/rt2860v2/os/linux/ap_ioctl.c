...
{ RTPRIV_IOCTL_GET_MAC_TABLE,
  IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | 1024 ,
  "get_mac_table"}, 
{ RTPRIV_IOCTL_GET_RESTRICTED_MACS,
  IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | 1024 ,
  "GetRestricted"}, 
{ RTPRIV_IOCTL_E2P,
  IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | 1024,
...
/* modified by Red@Ralink, 2009/09/30 */
		...
		case RTPRIV_IOCTL_GET_RESTRICTED_MACS:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GET_RESTRICTED_MACS, 0, NULL, 0);
		    break;
...
//		case RTPRIV_IOCTL_SET_CLI_ACCOUNT:
//			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_SET_CLI_ACCOUNT, 0, NULL, 0);
//			break;
